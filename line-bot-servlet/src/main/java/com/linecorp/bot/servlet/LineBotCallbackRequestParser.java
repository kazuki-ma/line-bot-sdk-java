...
public class LineBotCallbackRequestParser {
     ...
     */
    public CallbackRequest handle(final HttpServletRequest req)
     ...
     * Parse request.
     *
     * @deprecated This method transferred to {@link LineBotCallbackParser} in "line-bot-api-client" module which does not depend {@link HttpServletRequest}.
     * This delegate method will be deleted in future releases.
     *
    ...
    public CallbackRequest handle(String signature, String payload)
            throws LineBotCallbackException, IOException {
        return delegate.handle(signature, payload);
    }
}
