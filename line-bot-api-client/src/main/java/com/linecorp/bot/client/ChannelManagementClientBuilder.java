...
public class ChannelManagementClientBuilder extends AbstractClientBuilder<ChannelManagementClientBuilder> {
    ...
    public ChannelManagementSyncClient build() {
        final ChannelManagementClientRetrofitIface retrofitIface =
                buildRetrofitClient(ChannelManagementClientRetrofitIface.class);
